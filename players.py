...
class minimaxAI(connect4Player):
	...
	def vertWin(self, board):
		...
		if lowestRow > 0:
			...
			threat = 0
		# print("vert: maxCount ", maxCount, ", numOfSpaces ", lowestRow, ", multiplier ", multiplier, ", threat ", threat, ", posOfMax ", posOfMax)
		# print(board)
		#print("I exit here, vert")
		return threat
	...
	def horWin(self, board):
		...
		if((maxEndSpaces + maxMidSpaces + maxBeginningSpaces) > 0):
			...
			threat = 0
		# print("I exit here, hor")
		# print("hor: maxCount ", maxCount, ", numOfSpaces ", (maxBeginningSpaces + maxEndSpaces + maxMidSpaces), ", multiplier ", multiplier, ", threat ", threat, ", posOfMax ", posOfMax)
		# print(board)
		return threat
	...
	def leftDiagWin(self, board):
		...
		if((maxEndSpaces + maxMidSpaces + maxBeginningSpaces) > 0):
			...
			threat = 0
		#print("I exit here, left")
		# print("left: maxCount ", maxCount, ", numOfSpaces ", (maxBeginningSpaces + maxEndSpaces + maxMidSpaces), ", multiplier ", multiplier, ", threat ", threat, ", posOfMax ", posOfMax)
		# print(board)
		return threat
	...
	def rightDiagWin(self, board):
		...
		if((maxEndSpaces + maxMidSpaces + maxBeginningSpaces) > 0):
			...
			threat = 0	
		# print("I exit here, right")
		# print("right: maxCount ", maxCount, ", numOfSpaces ", (maxBeginningSpaces + maxEndSpaces + maxMidSpaces), ", multiplier ", multiplier, ", threat ", threat, ", posOfMax ", posOfMax)
		# print(board)
		return threat
...
class alphaBetaAI(connect4Player):
	...
	def getMove(self, board, depth):
		...
		Returns:
			[int]: [the column of best possible move that can be made at the depth that's being searched too]
		"""
		return self.maxValue(board, depth, -inf, inf, 0)
